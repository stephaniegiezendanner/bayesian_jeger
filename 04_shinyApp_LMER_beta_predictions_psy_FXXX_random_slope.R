...
model<-bf(y ~ MICF_mean  +(MICF_mean|psy) + (MICF_mean|F0XXX)+(MICF_mean|F1XXX)+
            (MICF_mean|F2XXX)+(MICF_mean|F3XXX)+(MICF_mean|F4XXX)+(MICF_mean|F5XXX)+
            (MICF_mean|F6XXX)+(MICF_mean|F7XX)+(MICF_mean|F8XXX)+(MICF_mean|F9XX))
...
hist(inverse_logit(rnorm(1000, 4.23, 1)),100)
